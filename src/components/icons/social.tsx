/**
 * Glifos de marca reales (no genéricos de un set de íconos como lucide, que
 * a propósito no incluye logos). Los trazos vienen tal cual de los SVG que
 * se bajaron para este fin: no se re-dibujan a mano para no desviarse del
 * logo oficial.
 */
